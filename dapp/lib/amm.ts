...
export function liquidityIx(tag:2|3,owner:PublicKey,pool:PublicKey,userA:PublicKey,userB:PublicKey,vaultA:PublicKey,vaultB:PublicKey,amountA:bigint,amountB:bigint){return ix([{pubkey:owner,isSigner:true,isWritable:false},{pubkey:pool,isSigner:false,isWritable:false},{pubkey:userA,isSigner:false,isWritable:true},{pubkey:userB,isSigner:false,isWritable:true},{pubkey:vaultA,isSigner:false,isWritable:true},{pubkey:vaultB,isSigner:false,isWritable:true},{pubkey:TOKEN_PROGRAM_ID,isSigner:false,isWritable:false}],Buffer.concat([Buffer.from([tag]),u64(amountA),u64(amountB)]))}
