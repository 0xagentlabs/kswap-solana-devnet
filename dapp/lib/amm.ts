...
export function seedInitialLiquidityIx(owner:PublicKey,pool:PoolState,ownerLp:PublicKey){const mint=lpMintPda(pool.address);return ix([{pubkey:owner,isSigner:true,isWritable:false},{pubkey:pool.address,isSigner:false,isWritable:false},{pubkey:pool.vaultA,isSigner:false,isWritable:false},{pubkey:pool.vaultB,isSigner:false,isWritable:false},{pubkey:mint,isSigner:false,isWritable:true},{pubkey:ownerLp,isSigner:false,isWritable:true},{pubkey:TOKEN_PROGRAM_ID,isSigner:false,isWritable:false}],Buffer.from([5]))}
